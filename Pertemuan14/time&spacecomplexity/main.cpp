...
int main()
{
    ...
    int arr[] = {8, 2, 19, 5, 7, 1, 8, 10, 16, 92, 20
                    9, 3, 6, 12, 72, 89, 99, 11, 4, 14, 22};
    ...
    cout << "Bubble Sort Time  \t: " << BubbleTime << " microsecond" << endl;//di perangkat 5 microsecond
    cout << "Bubble Sort O(1) Space \t: " << constanttime(3) << " Byte" << endl;

    double InsertionSort = TimeComplexity([&]() {
        insertionSort(arr,n);
    });
    cout << "Insertion Sort Time \t: " << InsertionSort << " microsecond" << endl;//di perangkat 2 microsecond
    cout << "Insertion O(1) Space\t: " << constanttime(4) << " Byte" << endl;

    double BinaryTime = TimeComplexity([&]() {
        binarySearch(arr, 0, n - 1, x);
    });
    cout << "Binary Search Time\t: " << BinaryTime << " microsecond" << endl;//di perangkat 0 microsecond
    cout << "Binary Search O(n)Space\t: " << constanttime(4) << " Byte" << endl;

    double LinearTime = TimeComplexity([&]() {
        linearSearch(arr,n, x);
    });
    cout << "Linear Search Time\t: " << LinearTime << " microsecond" << endl;//di perangkat 0 microsecond
    cout << "Linear Search O(n)Space\t: " << constanttime(3) << " Byte" << endl;

    double QuickTime = TimeComplexity([&]() {
        quickSort(arr,0, n - 1);
    });
    cout << "Quick Sort Time \t: " << QuickTime << " microsecond" << endl;//di perangkat 2 microsecond
